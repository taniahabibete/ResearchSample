...
public class ReferenceActivity extends AppCompatActivity implements StoreAdapter.MovieAdapterListener{

    private static final String TAG = StoreFragment.class.getSimpleName();
    private static final String URL = "http://minagazi.com/shamimsproject/api/SampleProjectListApi/index_reference";
