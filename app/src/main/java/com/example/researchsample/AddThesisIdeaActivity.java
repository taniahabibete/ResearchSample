...
public class AddThesisIdeaActivity extends AppCompatActivity {
    private static final String TAG = StoreFragment.class.getSimpleName();
    private Spinner VCategory;
    private Spinner VProject;
    private Spinner VUser;

    private EditText  name, sampleDescripton, developedBy,projectType, department,userType,uid,url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_thesis_idea);
        ...
        sampleDescripton = findViewById(R.id.description);
        developedBy = findViewById(R.id.genere);
        ...
        DatabaseHandler dbProfile = new DatabaseHandler(AddThesisIdeaActivity.this);
    ...
    private void postData(final String key) {
        ...
        String vUrl = url.getText().toString().trim();
        String picture = null;
        if (bitmap == null) {
            picture = "";
        } else {
        ...
        Call<AddThesis> call = apiInterface.insertThesisIdea(key,vname, vsampleDescripton, vdevelopedBy,vprojectType,vdepartment,picture,vuserType,vUploadBy,vUrl);
        ...
        call.enqueue(new Callback<AddThesis>() {
            ...
            public void onResponse(Call<AddThesis> call, Response<AddThesis> response) {
                ...
                if (value.equals("1")){
                    Toast.makeText(AddThesisIdeaActivity.this, "Waiting For Approval", Toast.LENGTH_SHORT).show();
                    finish();
                    getCallingActivity();
                    Intent intent = new Intent(AddThesisIdeaActivity.this, MainActivity.class);
            ...
            public void onFailure(Call<AddThesis> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(AddThesisIdeaActivity.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
