...
public class TeacherThesisActivity extends AppCompatActivity implements StoreAdapter.MovieAdapterListener{

    private static final String TAG = StoreFragment.class.getSimpleName();
    private static final String URL = "http://minagazi.com/shamimsproject/api/SampleProjectListTeacherApi";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_thesis);
