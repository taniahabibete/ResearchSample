...
public class ThesisIdeaListDetailActivity extends AppCompatActivity {
    public static String sampleSingleDetailUrl = "http://minagazi.com/shamimsproject/api/SampleProjectListApi/fetch_row_thesis_deatil?id=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thesis_idea_list_detail);
        ...
        patternType = findViewById(R.id.genere);
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                sampleDescription.setText(heroObject.getString("description"));
                                ...
                                patternType.setText("Pattern --> "+heroObject.getString("genere"));
